...
<body>
    ...
    <div class="container s">
         <h3>@yield('isi')</h3>
        <center><img src="img/CODE.png" alt="code1" width="1200px" height="auto" margin-bottom="50px"></center>
        <center><img src="img/CODE1.png" alt="code2" width="1200px" height="auto" margin-bottom="50px"></center>
    ...
    <small>Copyright &copy; 2022 - ANDREYUDI. All Rights Reserved.</small>
